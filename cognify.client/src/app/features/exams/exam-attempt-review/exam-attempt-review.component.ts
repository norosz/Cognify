...
@Component({
  selector: 'app-exam-attempt-review',
  standalone: true,
  imports: [
    CommonModule,
    RouterLink,
  ...
  templateUrl: './exam-attempt-review.component.html',
  styleUrl: './exam-attempt-review.component.scss'
})
export class ExamAttemptReviewComponent implements OnInit {
