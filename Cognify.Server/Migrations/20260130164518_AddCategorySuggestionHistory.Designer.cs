...
namespace Cognify.Server.Migrations
{
    ...
    [Migration("20260130164518_AddCategorySuggestionHistory")]
    partial class AddCategorySuggestionHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cognify.Server.Models.CategorySuggestionBatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CategorySuggestionBatches");
                });

            modelBuilder.Entity("Cognify.Server.Models.CategorySuggestionItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CategorySuggestionItems");
                });
            ...
            modelBuilder.Entity("Cognify.Server.Models.CategorySuggestionBatch", b =>
                {
                    b.HasOne("Cognify.Server.Models.Module", null)
                        .WithMany()
                        .HasForeignKey("ModuleId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Cognify.Server.Models.Quiz", null)
                        .WithMany()
                        .HasForeignKey("QuizId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
            ...
            modelBuilder.Entity("Cognify.Server.Models.CategorySuggestionItem", b =>
                {
                    b.HasOne("Cognify.Server.Models.CategorySuggestionBatch", "Batch")
                        .WithMany("Items")
